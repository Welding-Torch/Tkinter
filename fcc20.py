...
# Create Function to Edit to Update A Record
def edit():
    global editor
    editor = Tk()
    editor.title('Update A Record')
    editor.iconbitmap('C:/Users/bhati/hello/Tkinter/home_house_icon_250568.ico')
    ...
    # Creage Global Variables for text box names
